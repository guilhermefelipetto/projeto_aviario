...
if len(lista_verificadora_id_ambiente) <= 0:
    ...
    verifica_ambiente_registrado = True
...
def janela_registra_sensor_temperatura():
    ...
    if var_janela_registra_sensor_temperatura is None:
        ...
        var_janela_registra_sensor_temperatura.setGeometry(200, 200, 700, 500)
        ...
        nome_sensor_temperatura_label = QLabel("Nome do sensor de temperatura:", var_janela_registra_sensor_temperatura)
        ...
        id_ambiente_label = QLabel("Digite um ID de um ambiente cadastrado:", var_janela_registra_sensor_temperatura)
        ...
        label = QLabel(f"IDs registrados: {str_lista_id_ambiente}", var_janela_registra_sensor_temperatura)
        label.move(20, 130)
...
def janela_registra_sensor_umidade():
    ...
    if var_janela_registra_sensor_umidade is None:
        ...
        # Mostra todos os id_ambiente registrados
        label = QLabel(f"IDs registrados: {str_lista_id_ambiente}", var_janela_registra_sensor_umidade)
        label.move(20, 130)
        label.setFixedSize(400, 300)
...
def janela_registra_balanca():
    ...
    if var_janela_registra_balanca is None:
        ...
        # Mostra todos os id_ambiente registrados
        label = QLabel(f"IDs registrados: {str_lista_id_ambiente}", var_janela_registra_balanca)
        label.move(20, 130)
        label.setFixedSize(400, 300)
...
def janela_registra_ave():
    ...
    if var_janela_registra_ave is None:
        ...
        # Mostra todos os id_ambiente registrados
        label = QLabel(f"IDs registrados: {str_lista_id_ambiente}", var_janela_registra_ave)
        label.move(20, 170)
        label.setFixedSize(400, 300)
...
def janela_registra_alimento():
    ...
    if var_janela_registra_alimento is None:
        ...
        id_tipo_alimento_label = QLabel("Digite um ID de um tipo de alimento registrado:", var_janela_registra_alimento)
        ...
        # Mostra todos os id_ambiente registrados
        label_ambiente = QLabel(f"IDs registrados: {str_lista_id_ambiente}", var_janela_registra_alimento)
        label_ambiente.move(20, 170)
        label_ambiente.setFixedSize(400, 300)

        # Mostra todos os id_tipo_alimento registrados
        label_tipo_alimento = QLabel(f"IDs registrados: {str_lista_id_tipo_alimento}", var_janela_registra_alimento)
        label_tipo_alimento.move(400, 170)
        label_tipo_alimento.setFixedSize(550, 300)
